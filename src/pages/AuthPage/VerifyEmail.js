...
import ImageLight from '../../assets/images/resize/register.jpg'
...
const VerifyEmail = () => {
	...
	return (
		<>
			{location.state !== null && emailVetify !== '' && (
				<div className={styles.LoginContainer}>
					...
					<div className={styles.LoginSide}>
						<div className={styles.LoginForm}>
							...
							{!isSentVerify ? (
								<small>
									Chúng tôi sẻ gửi bạn mã xác thực vào email
									của bạn
								</small>
							) : (
								<small
