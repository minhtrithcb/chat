...
import ImageDark from '../../assets/images/resize/register.jpg'
			...
			<div className={styles.LoginSide}>
				<div className={styles.LoginForm}>
					...
					<form onSubmit={handleSubmit(onSubmit)}>
						<Input
							{...register('fullname', inpValid.fullname)}
							{...inputInit.fullname}
						/>
						<Input
						...
						/>
						<Input
							{...register('password', inpValid.password)}
							{...inputInit.password}
						/>
						<Input
							{...register('rePassword', inpValid.rePassword)}
							{...inputInit.rePassword}
						/>
						<Button
							disabled={loading}
							type='submit'
